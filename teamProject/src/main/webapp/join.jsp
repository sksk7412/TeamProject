...
<body>
	...
	<div class="buttons">
     ...
     <h3>필수 입력 정보</h3>
     아이디 <input type="text" name="UserId" placeholder="아이디를 입력해주세요." class="req"><br>
	 비밀번호 <input type="password" name="UserPw" placeholder="비밀번호를 입력해주세요." class="req"><br>
	 이름 <input type="text" name="name" placeholder="이름을 입력해주세요." class="req"><br>
	 휴대폰 <input class="req" type="text" id="mobile" 
	 name="mobile" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" placeholder="mobile" title="###-####-####"><br>
     ...
     <div class="warning">
      	<span>이용약관, 개인 정보 수집 및 이용에 동의해주세요.</span>
     </div>
     <input type="submit" value="가입하기" onclick="checkVal(form)">
     </form>
      </div>
